...
humantic is a [Hugo] theme for documentation sets, with slick
media that mortals should be able to use.

It started as a website using the awesome [docsy] and then grew a bunch of
shortcodes using the [fomantic] CSS library. Bootstrap was phased out and a
few more helpers added. This is **work in progress** - use at your peril!
